...
namespace BusinessLayer.Security
{
    public class HashingHelper
    {
        ...
        public static void AnimalLoverCreatePasswordHash(string password, out byte[] passwordHash, out byte[] passwordSalt)
        {
            using (var hmac = new System.Security.Cryptography.HMACSHA512())
            {
                passwordSalt = hmac.Key;
        ...
        public static bool AnimalLoverVerifyPasswordHash(string password, byte[] passwordHash, byte[] passwordSalt)
        {
